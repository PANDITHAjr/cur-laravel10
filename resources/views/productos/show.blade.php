...
<header>
    ...
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Producto: {{$producto->nombre}} </h1>
    </div>
    </header>
    <br>
...
<div>
    <div class="px-4 sm:px-0">
      <h3 class="text-base font-semibold leading-7 text-gray-900">Numero de producto: {{$producto->id}}</h3>
          ...
          <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
            <ul role="list" class="divide-y divide-gray-100 rounded-md border border-gray-200">
              <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                ...
                <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-green-500 rounded"><a href="{{route('producto.index')}}">volver</a></button>
                <button class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 border border-yellow-500 rounded"> <a href="{{route('producto.edit', $producto)}}">Editar</a></button>
                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded"> <a href="{{route('producto.destroy', $producto)}}">Eliminar</a></button>
