...
@section('contenido')
    ...
    <h1>Aquí se mostrarán todos los productos</h1>
    <br>
        ...
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
            ...
            @foreach ($prod as $produ)
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <td class="px-6 py-4"><a href="{{ route('producto.show', $produ->id) }}">{{ $produ->nombre }} </a></td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-end gap-2">
                            <a x-data="{ tooltip: 'Delete' }" href="{{ route('producto.destroy', $produ->id) }}">
                            ...
                            <a x-data="{ tooltip: 'Edite' }" href="{{ route('producto.edit', $produ->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6" x-tooltip="tooltip">
                                    <path stroke-linecap="round" stroke-linejoin="round"
